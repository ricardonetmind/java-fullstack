...
CREATE TABLE `almacen` (
  ...
  CONSTRAINT `fk_almacen_cosmetico` FOREIGN KEY (`cosmetico`) REFERENCES `maquillaje` (`mid`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE `compra` (
  ...
  KEY `fk_compra_maquillaje_idx` (`cosmetico`),
  CONSTRAINT `fk_compra_maquillaje` FOREIGN KEY (`cosmetico`) REFERENCES `maquillaje` (`mid`) ON DELETE NO ACTION ON UPDATE NO ACTION,
